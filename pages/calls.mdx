...
- [RegenData.xyz](https://RegenData.xyz) - Gitcoin Dataset (contact Umar for inviite)
- [Gitcoin Data Portal](https://github.com/davidgasquez/gitcoin-grants-data-portal) - Gitcoin dataset ([data](http://grant-data.xyz/), [docs](https://davidgasquez.github.io/gitcoin-grants-data-portal/))
- [OSObserver](https://www.opensource.observer/) - RetroPGF data set (contact Carl for invite)
