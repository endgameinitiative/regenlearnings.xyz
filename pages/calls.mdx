...
- [RegenData.xyz](https://RegenData.xyz) -  Metabase instance + database with Gitcoin data (contact Umar for inviite)
- [Gitcoin Data Portal](https://github.com/davidgasquez/gitcoin-grants-data-portal) - data on Gitcoin rounds as flat files (go [here](http://grant-data.xyz/) for data)
