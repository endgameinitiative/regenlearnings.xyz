...
We held the first [Data Bootcamp Intro Call](https://lu.ma/event/evt-OKMLvmtOr8ph67v) on Feb 16, 2024.

We have two learning tracks: Pandas (more beginner) and Foxes (more advanced). Umar, David, Humpty, Sardius, Doge, and Carl are helping facilitate. 

The Pandas group is larger and focused on helping people get learn the basics of Python and SQL and apply them to regen data. 
